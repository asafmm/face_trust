var jsPsychHtmlKeyboardResponse = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          allow_click: {
            type: jspsych.ParameterType.BOOL,
            pretty_name: "Reponse includes click",
            default: false,
         }
      },
  };
  ...
  class HtmlKeyboardResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          const end_trial = () => {
              ...
              document.querySelector(".jspsych-content-wrapper").removeEventListener("click", click_func, false);
              document.querySelector(".jspsych-content-wrapper").removeEventListener("contextmenu", click_func, false);
          ...
          if (trial.allow_click){
            document.querySelector(".jspsych-content-wrapper").addEventListener("click", click_func);
            document.querySelector(".jspsych-content-wrapper").addEventListener("contextmenu", click_func);
            }
